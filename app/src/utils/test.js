...
// const categories = [...new Set([...products.map((ele) => ele.category)])];

// console.log(categories.map((ele) => ({
//   value: ele,
//   label: ele.split("-").join(" "),
//   checked: false,
// })))

const brands = [...new Set([...products.map((ele) => ele.brand)])];

console.log(brands.map((ele) => ({
  value: ele,
  label: ele.split("-").join(" "),
  checked: false,
})))
